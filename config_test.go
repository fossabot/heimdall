...
var (
	badJSON    = `"name":"www.example.com","backends":["127.0.0.1:80","127.0.0.1:80","127.0.0.1:80"],"weights":[5,1],"ratio":0.3,"paths":["/"],"methods":["GET"],"whitelistIps":{"192.168.0.0"}}`
	badConfig  = `{"name":"www.example.com","backends":["127.0.0.1:80","127.0.0.1:80","127.0.0.1:80"],"weights":[5,1],"ratio":0.3,"paths":["/"],"methods":["GET"],"whitelistIps":["0.0.0.0"]}`
	goodConfig = `{"name":"www.example.com","backends":["127.0.0.1:80","127.0.0.1:80","127.0.0.1:80"],"weights":[5,1,1],"ratio":0.3,"paths":["/"],"methods":["GET"],"whitelistIps":["192.168.0.1"]}`
)
...
func TestCheckAPPConfig(t *testing.T) {
	...
	// check whitelist ips
	config.WhitelistIPs = []string{"192.168.1.22"}
	if err := checkAppConfig(config); err == nil {
		t.Errorf("should return error but not")
	}
	...
	config.Paths = []string{"/"}
	config.Methods = []string{"get"}
	config.WhitelistIPs = []string{"192.168.1.1"}
